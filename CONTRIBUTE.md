...
to HTTP parsing, dispatch, or response framing must run h1spec. The exact CI
commands and report gate are documented in
...
5. Pass Autobahn and h1spec compliance on the release commit.
