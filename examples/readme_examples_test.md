...
(`µWebZockets v1.3.0  ready in N ms`, then `→ Local:`, `→ Logs:`, and
`→ Metrics:` lines) before the first accepting listener; a one-line
...
allocates; `App.set_dev_log_file` redirects the output and
